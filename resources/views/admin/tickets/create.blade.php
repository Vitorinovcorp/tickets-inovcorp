            ...
            <form action="{{ route('admin.tickets.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="estado_id" id="estado_id" 
                                class="form-select @error('estado_id') is-invalid @enderror" required>
                            <option value="">Selecione...</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="contacto_criador_id" id="contacto_criador_id" 
                                class="form-select @error('contacto_criador_id') is-invalid @enderror" required>
                            <option value="">Selecione...</option>
                ...
                <div class="mb-3">
                    ...
                    <select name="operador_associado_id" id="operador_associado_id" 
                            class="form-select @error('operador_associado_id') is-invalid @enderror">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="mensagem" id="mensagem" 
                              ...
                              rows="10" required>{{ old('mensagem') }}</textarea>
                    @error('mensagem')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
